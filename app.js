...
const scrollToTopButton = document.getElementById("scroll-to-top-button");
  ...
  function find_avai() {
    ...
    document.getElementById("calc1").innerHTML =
      "&nbsp Calculating the Available Matrix...." +
      "<br/>" +
      "Available[n] = Total no. of instances - (Allocation[0][n] + Allocation[1][n] + Allocation[2][n] + Allocation[3][n] + Allocation[4][n])" +
      "<br/>";
    document.getElementById("calc1").innerHTML +="<span style='font-size: 16px; color: #800000; font-family: Arial;'>"+ "Available[0] = " + a + " - ";
    document.getElementById("calc2").innerHTML ="<span style='font-size: 16px; color: #800000; font-family: Arial;'>"+ "Available[1] = " + b + " - ";
    document.getElementById("calc3").innerHTML ="<span style='font-size: 16px; color: #800000; font-family: Arial;'>"+ "Available[2] = " + c + " - ";
    for (var i = 1; i <= 5; i++) {
      var x = x + parseInt(document.getElementById("a" + i + "1").value);
      document.getElementById("calc1").innerHTML += "<span style='font-size: 16px; color: #800000; font-family: Arial;'>"+parseInt(
        document.getElementById("a" + i + "1").value
      );
      if (i < 5) {
        document.getElementById("calc1").innerHTML +="<span style='font-size: 16px; color: #800000; font-family: Arial;'>"+ "+";
      } else {
        document.getElementById("calc1").innerHTML +="<span style='font-size: 16px; color: #800000; font-family: Arial;'>"+ " = ";
      }
      var y = y + parseInt(document.getElementById("a" + i + "2").value);
      document.getElementById("calc2").innerHTML +="<span style='font-size: 16px; color: #800000; font-family: Arial;'>"+ parseInt(
        document.getElementById("a" + i + "1").value
      );
      if (i < 5) {
        document.getElementById("calc2").innerHTML +="<span style='font-size: 16px; color: #800000; font-family: Arial;'>"+ "+";
      } else {
        document.getElementById("calc2").innerHTML +="<span style='font-size: 16px; color: #800000; font-family: Arial;'>"+ " = ";
      }
      var z = z + parseInt(document.getElementById("a" + i + "3").value);
      document.getElementById("calc3").innerHTML +="<span style='font-size: 16px; color: #800000; font-family: Arial;'>"+ parseInt(
        document.getElementById("a" + i + "1").value
      );
      if (i < 5) {
        document.getElementById("calc3").innerHTML +="<span style='font-size: 16px; color: #800000; font-family: Arial;'>"+ "+";
      } else {
        document.getElementById("calc3").innerHTML +="<span style='font-size: 16px; color: #800000; font-family: Arial;'>"+ " = ";
      }
    }
    document.getElementById("av11").value = a - x;
    document.getElementById("calc1").innerHTML += "<span style='font-size: 16px; color: #800000; font-family: Arial;'>"+ (a - x);
    document.getElementById("av12").value = b - y;
    document.getElementById("calc2").innerHTML +="<span style='font-size: 16px; color: #800000; font-family: Arial;'>"+ (b - y);
    document.getElementById("av13").value = c - z;
    document.getElementById("calc3").innerHTML +="<span style='font-size: 16px; color: #800000; font-family: Arial;'>"+ (c - z);
  ...
  function find_need() {
    document.getElementById("calc1").innerHTML =
      "&nbsp Calculating the Need Matrix...." +
      "<br/>" +
  ...
  function find_sequence() {
    ...
    var k = 1;
    document.getElementById("calc0").innerHTML =
      "&nbsp Calculating the Final Order...." + "<br/>";
    for (var j = 1; j <= 5; j++) {
        ...
        if (ex1 != 0 || ex2 != 0 || ex3 != 0) {
          if (
            ...
            document.getElementById("calc" + j).innerHTML +=
              ...
              " ) => Process P" +
              i +
              " is selected. And New Available Matrix is ( " +
              document.getElementById("av11").value +
              ", " + "<span style='font-size: 16px; color: #800000; font-family: Arial;''>"+
              document.getElementById("av12").value +
              ", " +
